...
public class TestPlanExecutor {
     ...
     *
     * @param planMaker List of discovery selectors to be executed
     * @param testPackage Package to scan for test classes
     */
    public void runTests(final IPlanMaker planMaker, final String testPackage) {
        executeTestPlan(planMaker.scanTests(testPackage));
    }
}
