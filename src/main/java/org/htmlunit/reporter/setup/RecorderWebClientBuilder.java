 ...
 * with custom configurations provided by {@code WebClientRecorderStrategy} instances.
 * <p>
...
public class RecorderWebClientBuilder {
    private final List<WebClientRecorderStrategy> strategies_;

    /**
     * Constructs a new instance of {@code RecorderWebClientBuilder}.
     *
     * Initializes an internal list to hold {@code WebClientRecorderStrategy} instances.
     * These strategies can be used to configure and modify the behavior of a {@code WebClient}
     * during the build process.
     */
    public RecorderWebClientBuilder() {
    ...
    public WebClient build() {
        ...
        for (final WebClientRecorderStrategy strategy : strategies_) {
