 ...
 * Usage example:
 * RecorderFactory.addRecorder("key1", new Recorder());
 * Recorder recorder = RecorderFactory.getRecorder("key1");
 * boolean exists = RecorderFactory.containsRecorder("key1");
 * RecorderFactory.removeRecorder("key1");
 * Map<> allRecorders = RecorderFactory.getAllRecorders();
 * RecorderFactory.clearAllRecorders();
 * @author Akif Esad
 */
public final class RecorderFactory {
    ...
    private RecorderFactory() {
        throw new AssertionError("RecorderFactory cannot be instantiated");
    }
     ...
     */
    public static void addRecorder(final String key, final Recorder recorder) {
